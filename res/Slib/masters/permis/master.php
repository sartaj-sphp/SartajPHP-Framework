...
if(getCurrentRequest() == "index") getFrontPlace("main_master",'centersp1')->maindiv->fu_unsetRenderTag();
runFrontPlace('main_master','centersp1');
$sj1 = SphpBase::SphpJsM();
$sj1::addBootStrap(); 
echo SphpBase::sphp_api()->getHeaderHTML(); 
?>
<link href="<?php echo SphpBase::sphp_settings()->slib_res_path ; ?>/masters/permis/css/framework.css" rel="stylesheet"  type="text/css" />
</head>
<body class="h-100">
