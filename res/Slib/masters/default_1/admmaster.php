...
<link href="<?php print $slibrespath; ?>/masters/default/css/framework.css" rel="stylesheet"  type="text/css" />
...
<h1 class="heading padding-top padding-bottom">
    <img src="<?php print $slibrespath; ?>/masters/default/imgs/favicon-32x32.png" />&nbsp;&nbsp;<?php print $cmpname; ?></h1>
            </div></div>
