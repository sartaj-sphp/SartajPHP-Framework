...
public $brandicon = "";
public $navbarClasses = "nav navbar-dark nav-pills flex-column  mb-sm-auto mb-0 align-items-center align-items-sm-start";

public $template_menu_startroot = '<li class="nav-item nav-dli"><a class="nav-link nav-dlink align-middle px-0" data-bs-toggle="collapse" data-target="#$mnuhref2" href="#$mnuhref2" >' . 
...
public $template_menu_start = '<li class="nav-item nav-dli"><a class="nav-link nav-dlink collapsed align-middle px-0" data-bs-toggle="collapse" data-target="#$mnuhref2" href="#$mnuhref2" >' . 
