...
class Grid1 extends \Sphp\tools\Component{
public $pageNo = -1;
public $totalPages = 1;
...
$_SESSION[$name.'pc'] = $gate->gate;
}else{
$_REQUEST[$name . 'page'] = 1;
if(isset($_SESSION[$name.'pc']) && $_SESSION[$name.'pc'] == $gate->gate){
...
$mysql->connect();
$res = $mysql->executeQuery($this->pageCountSQL);
...
$tmpf = new FrontFile($this->strFormat,true);
$tmpf->run();
$stro .= $tmpf->data;
 }
//$this->unsetrenderTag();
