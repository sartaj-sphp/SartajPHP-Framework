...
protected function publishAndroidApp($curdirpath) {
    $workpath = $curdirpath . "/apps/android";
    $publish_path = $curdirpath . "/app/src/main/java/" . str_replace('.', '/', $this->mobappid);
    if(! \DIR::directoryExists($workpath)){
        ...
        $this->dir->directoryCopy($this->phppath . "/jslib/mobileapp/android",$workpath);
        //file_put_contents($workpath . '/config.xml',file_get_contents($this->phppath . "/jslib/mobileapp/android/config.xml"));
    }
   // if(! \DIR::directoryExists($publish_path)){
    if(! file_exists($curdirpath . "/app/libs/webviewlib-release.aar")){
         $this->dir->directoriesCreate($publish_path);
         //if(file_exists($curdirpath . "/app/libs")){
             copy($this->phppath . "/jslib/mobileapp/android/webviewlib-release.aar",$curdirpath . "/app/libs/webviewlib-release.aar");
             file_put_contents($curdirpath . '/app/build.gradle.kts', \SphpBase::sphp_api()->getDynamicContent($workpath . '/build.gradle.kts',$this));
             file_put_contents($publish_path . '/MainActivity.kt', \SphpBase::sphp_api()->getDynamicContent($workpath . '/MainActivity.kt',$this));
            file_put_contents($curdirpath . '/app/src/main/AndroidManifest.xml', \SphpBase::sphp_api()->getDynamicContent($workpath . '/config.xml',$this));
        // }
    }
    
    $this->dir->directoryCopyChanges($curdirpath . '/www', $curdirpath . "/app/src/main/assets");
    //$this->dir->directoryCopyChanges($workpath . '/ui', $publish_path . "/ui");
    ...
    if(! file_exists($curdirpath . '/app/src/main/AndroidManifest.xml')){
        file_put_contents($curdirpath . '/app/src/main/AndroidManifest.xml', \SphpBase::sphp_api()->getDynamicContent($workpath . '/config.xml',$this));
    }
    if(! file_exists($publish_path . '/Index.kt')){
        file_put_contents($publish_path . '/Index.kt', \SphpBase::sphp_api()->getDynamicContent($workpath . '/Index.kt',$this));
    }
    if(! file_exists($publish_path . '/ui/theme')){
        $this->dir->directoryCopyChanges($workpath . '/ui', $publish_path . "/ui");
        file_put_contents($publish_path . '/ui/theme/Color.kt', \SphpBase::sphp_api()->getDynamicContent($workpath . '/ui/theme/Color.kt',$this));
        file_put_contents($publish_path . '/ui/theme/Theme.kt', \SphpBase::sphp_api()->getDynamicContent($workpath . '/ui/theme/Theme.kt',$this));
        file_put_contents($publish_path . '/ui/theme/Type.kt', \SphpBase::sphp_api()->getDynamicContent($workpath . '/ui/theme/Type.kt',$this));
        file_put_contents($curdirpath . '/app/src/main/res/values/themes.xml', \SphpBase::sphp_api()->getDynamicContent($workpath . '/themes.xml',$this));
        if(file_exists($curdirpath . "/app/src/main/res/values-night"))  file_put_contents($curdirpath . '/app/src/main/res/values-night/themes.xml', \SphpBase::sphp_api()->getDynamicContent($workpath . '/themes.xml',$this));
    }
...
protected function sendRenderData() {
    ...
    $this->publishAndroidApp($curdirpath);
    $stro2 = "";
    $stro = '<!DOCTYPE html>
<html>
<head lang="en">
...
';
    ...
    \SphpBase::sphp_api()->safeWriteFile('www/index.html', $stro . '' . $stro2);
