...
class SocketServer
{
	...
	/*
      $this->wsClientsExt[ integer ClientID ] = array(0 => userID,1=> userIDTo); //for extra data storage
	...
	*/
	...
	function wsBuildClientFrame($clientID, &$buffer, $bufferLength) {
		...
		// check if the length of the frame's payload data has been fetched, if not then atfrontt to fetch it from the frame buffer
