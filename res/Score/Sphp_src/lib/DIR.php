...
public function isIgnoreFolder($folder,$ignore_folder=array()) {
    if(\SphpBase::sphp_api()->array_search_i($folder, $ignore_folder)!== false){
        return true;
    }else{
        return false;
    }
...
public function isIgnoreFile($file,$ignore_file=array()) {
    if(\SphpBase::sphp_api()->array_search_str($file, $ignore_file)!== false){
        return true;
    }else{
        return false;
    }
...
public function isIgnoreFileExtention($extention,$ignore_file_extentions=array()) {
    if(\SphpBase::sphp_api()->array_search_i($extention, $ignore_file_extentions)!== false){
        return true;
    }else{
        return false;
    }
...
public function isNotIgnoreFolder($folder,$lst_folder=array()) {
    if(count($lst_folder) === 0){
        return true;
    }else if(\SphpBase::sphp_api()->array_search_i($folder, $lst_folder)!== false){
        return true;
    }else{
        return false;
    }
