...
$this->installer1 = new FrontFile(SphpBase::sphp_settings()->slib_path . "/apps/plugins/forms/installer.php",false,null,$this);
$this->config1 = new FrontFile(SphpBase::sphp_settings()->slib_path . "/apps/plugins/forms/config.php",false,null,$this);
$this->prop1 = new FrontFile(SphpBase::sphp_settings()->slib_path . "/apps/plugins/forms/view_plugin.php",false,null,$this);
...
$this->installer1->mjk->setInnerHTML("Plugin Installed Succesfully into Your Website");
$this->setFrontFile($this->installer1);
}else{
setErr('app', "You are Required fund in your account to purchase this plugin");
$this->setFrontFile($this->prop1);
}
}
else{
$this->setFrontFile($this->prop1);
...
$this->setFrontFile($this->config1);
}
