...
class SphpBase {
    ...
    /* @static \Sphp\tools\FrontFile $dynData */
...
function runSartajPHPEngine(){
    ...
    // create engine and create all sphp objects
    $engine = new Sphp\Engine();
    // set all sphp object reference to SphpBase
    SphpBase::setReady($engine);
    // parse request to sphp_request, create page object and ready to pocess
    $engine->start();
    /*
    // default variables
    ...
    */
    ...
    try {
        ...
        SphpBase::debug()->Sphp_exception_handler($e);
        //throw new \Sphp\core\Exception($e->getMessage() . ' File:- ' . $e->getFile() . ' Line:- ' . $e->getLine() . ' traceback:- ',1, $e);
    } catch (\Exception $e) {
        SphpBase::debug()->Sphp_exception_handler($e);
        //throw new \Sphp\core\Exception($e->getMessage() . ' File:- ' . $e->getFile() . ' Line:- ' . $e->getLine() . ' traceback:- ',1, $e);
    }
